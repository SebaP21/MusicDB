...
const NavMobileClient = ({ offers }: { offers: OfferLink[] }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Image src={closeBtn} alt={"close-btn"} width={30} height={30} />
        </button>
        <Link
          onClick={onClickNav}
          href={"/#about"}
        ...
        <div onClick={onClickOfferNav} className="flex flex-col items-center  ">
          <h4
          ...
          >
            <div className=" flex flex-col gap-10 mt-10 text-center text-lg uppercase">
              <OfferLinkComponent offers={offers} onClick={onClickNav} />
            </div>
          </div>
        </div>
        <Link
